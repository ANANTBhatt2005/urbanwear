<?php
session_start();
// MEN Category - premium catalog view
...
<head>
  ...
  <meta name="category" content="men" />
  <title>Men | UrbanWear Collection</title>
...
<body>
  ...
  <div class="marquee-strip">
    <div class="marquee-track">
      <span>Men's Collection 2025</span>
  ...
  <header class="plp-hero">
    ...
    <!-- Left content -->
    <div class="hero-left">
      <div class="plp-hero-eyebrow">Essentials 2025</div>
      <h1>Men's <em>Collection</em></h1>
      <p>Modern staples. Engineered for the city.</p>
      <div class="hero-stats">
        <div class="hero-stat"><span class="stat-num">200+</span><span class="stat-label">Styles</span></div>
        <div class="hero-stat-divider"></div>
        <div class="hero-stat"><span class="stat-num">Premium</span><span class="stat-label">Fabrics</span></div>
        <div class="hero-stat-divider"></div>
        <div class="hero-stat"><span class="stat-num">New</span><span class="stat-label">Weekly Drops</span></div>
      </div>
    </div>
    ...
    <aside id="plp-sidebar">
      ...
      <div class="sf-group">
        ...
        <div class="sf-color-grid">
          <button class="sf-color-swatch" data-color="Black"    title="Black"    style="background:#111;"></button>
          <button class="sf-color-swatch" data-color="White"    title="White"    style="background:#fff; border-color:var(--glass-border);"></button>
          <button class="sf-color-swatch" data-color="Navy"     title="Navy"     style="background:#1b2a4a;"></button>
          <button class="sf-color-swatch" data-color="Grey"     title="Grey"     style="background:#888;"></button>
          <button class="sf-color-swatch" data-color="Beige"    title="Beige"    style="background:#c8b89a;"></button>
          <button class="sf-color-swatch" data-color="Olive"    title="Olive"    style="background:#6b7445;"></button>
          <button class="sf-color-swatch" data-color="Brown"    title="Brown"    style="background:#7b4f2e;"></button>
          <button class="sf-color-swatch" data-color="Burgundy" title="Burgundy" style="background:#6e2130;"></button>
        </div>
      </div>
